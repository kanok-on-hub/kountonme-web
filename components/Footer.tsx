      ...
      <Container>
        <div className="w-full max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1.5fr] gap-[8vw] md:gap-[4vw] items-start px-[2vw]">
          ...
          <div className="flex flex-col gap-[2vw] md:gap-[0.8vw] md:pl-[2vw]">
            ...
            <ul className="flex flex-col gap-[1.5vw] md:gap-[0.4vw]">
              <li><a href="#workforce" className="text-[3.2vw] md:text-[1vw] lg:text-[0.85vw] text-slate-500 hover:text-[#0B132B] transition-colors font-medium font-sans">ทีมงานดิจิทัล</a></li>
              <li><a href="#how-it-works" className="text-[3.2vw] md:text-[1vw] lg:text-[0.85vw] text-slate-500 hover:text-[#0B132B] transition-colors font-medium font-sans">วิธีการทำงาน</a></li>
              <li><a href="#use-cases" className="text-[3.2vw] md:text-[1vw] lg:text-[0.85vw] text-slate-500 hover:text-[#0B132B] transition-colors font-medium font-sans">ตัวอย่างทีมงาน</a></li>
            </ul>
          </div>
          ...
          <div className="flex flex-col gap-[2vw] md:gap-[0.8vw]">
            ...
            <ul className="flex flex-col gap-[2.5vw] md:gap-[0.8vw]">
              <li className="flex items-center gap-[2vw] md:gap-[0.8vw]">
                <svg className="w-[3.5vw] md:w-[0.9vw] h-[3.5vw] md:h-[0.9vw] text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
              ...
              <li className="flex items-center gap-[2vw] md:gap-[0.8vw] whitespace-nowrap">
                <svg className="w-[3.5vw] md:w-[0.9vw] h-[3.5vw] md:h-[0.9vw] text-slate-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
              ...
              <li className="flex items-center gap-[2vw] md:gap-[0.8vw] whitespace-nowrap">
                <svg className="w-[3.5vw] md:w-[0.9vw] h-[3.5vw] md:h-[0.9vw] text-slate-400" fill="currentColor" viewBox="0 0 24 24">
