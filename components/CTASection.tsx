...
export const CTASection = ({ lang = "TH" }: { lang?: string }) => {
  ...
  const content = {
    TH: {
      ...
      button: "✦ เริ่มออกแบบ Workflow ของคุณ"
    },
    EN: {
      headline: (
        <>
          Workflow that works<br />
      ...
      <Container>
        ...
        >
          ...
          <div className="relative z-10 w-full max-w-3xl mx-auto text-center">
            <h2 className={`text-[5.5vw] md:text-[2.8vw] lg:text-[2.2vw] font-black text-white mb-[8vw] md:mb-[3.5vw] leading-[1.3] tracking-tighter ${lang === 'TH' ? 'font-display' : 'font-sans'}`}>
              {t.headline}
            </h2>
            ...
            <button
              ...
              className={`h-[11vw] md:h-[4.5vw] lg:h-[3.5vw] px-[8vw] md:px-[3vw] bg-white text-[#0B132B] rounded-full font-black text-[3.2vw] md:text-[1.5vw] lg:text-[1.1vw] shadow-lg hover:bg-[#6EE7B7] hover:text-[#0B132B] transition-all cursor-pointer flex items-center justify-center mx-auto active:scale-95 tracking-tight ${lang === 'TH' ? 'font-display' : 'font-sans'}`}
            >
              {t.button}
            </button>
          </div>
